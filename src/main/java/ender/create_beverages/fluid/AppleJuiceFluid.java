...
public abstract class AppleJuiceFluid extends FlowableFluid {
    ...
    public Fluid getStill() {
        return ModFluids.STILL_APPLE_JUICE;
    }
    ...
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.APPLE_JUICE_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
